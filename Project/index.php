    ...
    <main id="main" class="main-content">
        <section class="hero">
            <div class="grid-container">
                ...
                <p>Our mission is to document and share information about the native plants,
                    animals, and insects of Manitoba. </p>
            </div>
        </section>
            ...
            <div class="grid-container">
                ...
                <div class="species-grid">
                    <article class="species-card">
                        ...
                        <a href="species_details.php">Learn More</a>
                    </article>
                    <article class="species-card">
        ...
        <section class="about">
            <div class="grid-container">
                ...
                <p>
                    ...
                    We provide educational resources to the public through our content management system.
                </p>
            </div>
        </section>
    </main>
